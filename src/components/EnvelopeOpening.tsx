...
const EnvelopeOpening = ({
  ...
  return (
    <div 
      ref={containerRef}
      className="fixed inset-0 z-[100] bg-gradient-to-b from-cream via-warm-cream to-cream flex items-center justify-center overflow-hidden"
    >
      ...
      <div className="absolute inset-0">
        <img 
          ...
          src="/lovable-uploads/5f8e9aca-8702-4aab-9742-01aed30d5f21.png" 
      ...
      <div ref={sparklesRef}>
        {[...Array(6)].map((_, i) => (
          <Sparkles 
            key={i} 
            className="sparkle-item absolute text-dusty-rose/40" 
            style={{
              left: `${10 + i * 15}%`,
              top: `${15 + i % 3 * 25}%`,
              width: `${14 + i % 3 * 6}px`,
