...
const FloralDecoration = ({ position, className = "", size = "md" }: FloralDecorationProps) => {
  const sizeClasses = {
    ...
    >
      <svg viewBox="0 0 200 200" className="w-full h-full opacity-70">
        ...
        <g transform="translate(30, 30)">
          {/* Petals */}
          <ellipse cx="40" cy="20" rx="20" ry="35" fill="url(#petalGradient)" opacity="0.9" transform="rotate(-30, 40, 40)" />
          <ellipse cx="60" cy="25" rx="18" ry="30" fill="url(#petalGradient)" opacity="0.85" transform="rotate(15, 40, 40)" />
          <ellipse cx="35" cy="50" rx="22" ry="32" fill="url(#petalGradient)" opacity="0.8" transform="rotate(-60, 40, 40)" />
          <ellipse cx="55" cy="55" rx="16" ry="28" fill="url(#petalGradient)" opacity="0.75" transform="rotate(40, 40, 40)" />
        ...
        <g transform="translate(120, 100)">
          <ellipse cx="15" cy="8" rx="8" ry="14" fill="url(#petalGradient)" opacity="0.8" transform="rotate(-25, 15, 15)" />
          <ellipse cx="22" cy="10" rx="7" ry="12" fill="url(#petalGradient)" opacity="0.75" transform="rotate(20, 15, 15)" />
          <ellipse cx="12" cy="20" rx="9" ry="13" fill="url(#petalGradient)" opacity="0.7" transform="rotate(-50, 15, 15)" />
          <circle cx="17" cy="15" r="4" fill="hsl(40, 60%, 85%)" />
        </g>

        {/* Leaves */}
        <g transform="translate(80, 140)">
          <ellipse cx="20" cy="30" rx="8" ry="25" fill="url(#leafGradient)" opacity="0.8" transform="rotate(-20, 20, 30)" />
          <ellipse cx="35" cy="25" rx="6" ry="20" fill="url(#leafGradient)" opacity="0.7" transform="rotate(15, 35, 25)" />
          <ellipse cx="50" cy="35" rx="7" ry="22" fill="url(#leafGradient)" opacity="0.75" transform="rotate(30, 50, 35)" />
        </g>
