...
const HeroSection = ({
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-cream">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-16">
        ...
        <div className={`grid grid-cols-12 gap-3 md:gap-4 max-w-3xl mx-auto mb-10 transition-all duration-1000 delay-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          {/* Main large photo */}
        ...
        {/* Guest Name */}
        {guestName && <div className={`mt-8 transition-all duration-700 delay-800 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
        ...
        {/* Scroll Indicator */}
        <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 transition-all duration-1000 delay-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
