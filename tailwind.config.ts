  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'mauve': 'hsl(var(--mauve))',
        'mauve-light': 'hsl(var(--mauve-light))',
        ...
        'dusty-rose': 'hsl(var(--mauve))',
        'soft-rose': 'hsl(var(--mauve))',
        'warm-blush': 'hsl(var(--dusty-pink))',
        'cream-white': 'hsl(var(--cream))',
        'soft-taupe': 'hsl(var(--soft-beige))',
        'blush-pink': 'hsl(var(--dusty-pink))',
        'olive-green': 'hsl(var(--sage-green))',
